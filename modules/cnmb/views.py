            ...
            try:
                ...
                if physic is None:
                    ...
                    group_level_five = GroupATC.objects.using(
                        database).filter(
                        code=row['code_level5']).first()
                    if group_level_five is None:
                        group_level_five = GroupATC()
                        group_level_five.code = code = row['code_level5']
